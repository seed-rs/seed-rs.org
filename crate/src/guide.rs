...
pub fn guides() -> Vec<Guide> {
    vec![
        ...
        guide!(seed_version: "0.7.0", slug: "app_3_auth", menu_title: "App 3: Auth", file_name: "app_3_auth", prepend_menu_divider: true),
        guide!(seed_version: "0.7.0", slug: "advanced_concepts", menu_title: "Advanced Concepts", file_name: "advanced_concepts", prepend_menu_divider: true),
