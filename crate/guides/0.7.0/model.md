...
- It can be almost anything - type alias, [enum](https://doc.rust-lang.org/book/ch06-00-enums.html), etc. However the most `Model`s are [structs](https://doc.rust-lang.org/book/ch05-00-structs.html) in real-world apps.
...
- Try to be as expressive as possible and make impossible business rules unrepresentable in code by encoding them with Rust type system.
   - The basic rule is - when you see multiple fields with the same common/primitive Rust type (`bool`, `String`, `u32`, `Option`, etc.) in your `Model`, then you should try to remodel it.
